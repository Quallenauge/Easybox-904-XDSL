...
#define PWR_CRTCL_SECT_INIT  spin_lock_init(&pwr_lock)
#define PWR_CRTCL_SECT_START spin_lock_irqsave(&pwr_lock, flag)
#define PWR_CRTCL_SECT_END   spin_unlock_irqrestore(&pwr_lock, flag)
