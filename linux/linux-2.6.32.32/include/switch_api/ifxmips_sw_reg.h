 ...
 *****************************************************************************
   \file ifxmips_sw_reg.h
   \remarks implement GPHY driver on VR9 platform
 *****************************************************************************/
#ifndef _IFXMIPS_SW_REG_H
#define _IFXMIPS_SW_REG_H 
...
#define VR9_GPIO_BASE_ADDR                  (0xBE100B00)

/* Port 0 Direction Register									 */
#define P0_DIR															(VR9_GPIO_BASE_ADDR + 0x18)
/* Port 0 Alternate Function Select Register 0 */
#define P0_ALTSEL0													(VR9_GPIO_BASE_ADDR + 0x1C)
/* Port 0 Alternate Function Select Register 1 */
#define P0_ALTSEL1													(VR9_GPIO_BASE_ADDR + 0x20)


#define VR9_CGU_BASE_ADDR                   (0xBF103000)

/* Interface Clock Register									 */
#define IF_CLK															(VR9_CGU_BASE_ADDR + 0x24)
...
#define VR9_PMU_BASE_ADDR                   (0xBF102000)

/* PMU Power down Control Register					 */
#define PMU_PWDCR														(VR9_PMU_BASE_ADDR + 0x1C)
