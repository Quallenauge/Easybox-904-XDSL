/******************************************************************************
**
** FILE NAME    : ifxmips_sflash_danube.h
** PROJECT      : IFX UEIP
** MODULES      : Serial Flash
**
** DATE         : 03 July 2009
** AUTHOR       : Lei Chuanhua
** DESCRIPTION  : SPI Flash danube specific configuration
...
*******************************************************************************/
/*!
  \file ifxmips_sflash_danube.h
  \ingroup IFX_SFLASH
  \brief ifx serial flash driver DANUBE specific file
*/
#ifndef IFXMIPS_SFLASH_DANUBE_H
#define IFXMIPS_SFLASH_DANUBE_H
