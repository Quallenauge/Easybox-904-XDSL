/******************************************************************************
**
** FILE NAME    : ifxmips_usif_sflash.h
** PROJECT      : IFX UEIP
...
*******************************************************************************/
/*!
  \file ifxmips_usif_sflash.h
  \ingroup IFX_USIF_SFLASH
  \brief ifx usif serial flash driver header
*/
#ifndef IFXMIPS_USIF_SFLASH_H
#define IFXMIPS_USIF_SFLASH_H
...
#define	IFX_MAX_READY_WAIT_JIFFIES	(10 * HZ)	/* eg. M25P128 specs 6s max sector erase */
...
#define IFX_SFLASH_MAX_FLASH_TYPE 12  /* Per Vendor */
...
struct ifx_usif_sflash_manufacturer_info {
    char  *name;
    u8    id;
    struct ifx_usif_sflash_info flashes[IFX_SFLASH_MAX_FLASH_TYPE];
};
...
typedef struct {
    ...
    struct ifx_usif_sflash_manufacturer_info *manufacturer;
    struct ifx_usif_sflash_info        *flash;
    u8                      erase_opcode;
...
#include "ifxmips_usif_sflash_vr9.h"
#elif defined(CONFIG_AR10)
#include "ifxmips_usif_sflash_ar10.h"
#else
#error "Platform not specified!"
#endif

#endif  /* IFXMIPS_USIF_SFLASH_H */
