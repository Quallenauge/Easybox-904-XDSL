...
#ifndef _IFXMIPS_MMC_VR9_H_
#define _IFXMIPS_MMC_VR9_H_

/*!
  \file ifxmips_mmc_vr9.h
  \ingroup IFX_MMC_DRV
  \brief IFX MMC module gpio definition for VRx platforms
*/
...
void vr9_mmc_gpio_configure (void)
{
