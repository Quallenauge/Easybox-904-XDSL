 ...
 */
  ...
  extern unsigned int ifx_vr9_ppe_base_addr;
  #define IFX_PPE                       KSEG1ADDR(ifx_vr9_ppe_base_addr)
  #define IFX_PPE_ORG                   0x1E200000
#else
  #define IFX_PPE                       KSEG1ADDR(0x1E200000)
#endif
