...
#define ENABLE_ADTRAN                   1
#define CO_VERIFICATION                 0   //  enable this flag for testing with SmartBit
#define OFFCHIP_BONDING_TEST            0   //  enable this flag for testing with external memory as data buffer
