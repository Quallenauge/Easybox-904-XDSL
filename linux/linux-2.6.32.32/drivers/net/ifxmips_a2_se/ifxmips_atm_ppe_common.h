...
#define MBOX_IGU4_ISRS_SET(n)           (1 << (n))
#define MBOX_IGU4_ISRC_CLEAR(n)         (1 << (n))
#define MBOX_IGU4_ISR_ISR(n)            (*MBOX_IGU4_ISR & (1 << (n)))
#define MBOX_IGU4_IER_EN(n)             (*MBOX_IGU4_IER & (1 << (n)))
#define MBOX_IGU4_IER_EN_SET(n)         (1 << (n))
