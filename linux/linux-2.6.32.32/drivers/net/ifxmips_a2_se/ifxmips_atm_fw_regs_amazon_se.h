...
#define ERX_DMACH_ON                    SB_BUFFER(0x240D)
#define ETX_DMACH_ON                    SB_BUFFER(0x240E)
#define CFG_ETH_DMA_MODE                SB_BUFFER(0x240F)
#define CFG_ETH_DMA_POLL_BASE           SB_BUFFER(0x2408)
#define CFG_ETH_RXDMA_POLL_CNT          SB_BUFFER(0x2409)
#define CFG_ETH_TXDMA_POLL_CNT          SB_BUFFER(0x240A)
#define CFG_ETH_LOOPBACK                SB_BUFFER(0x240B)
...
//  Ethernet Structures
#define ETH_MIB_TABLE                   ((struct eth_mib_table *)           SB_BUFFER(0x2E20))
#define ERX_DMA_CHANNEL_CONFIG(i)       ((struct wrx_dma_channel_config *)  SB_BUFFER(0x2DE0 + (i) * 7))    //  i < 4
#define ETX_DMA_CHANNEL_CONFIG(i)       ((struct wtx_dma_channel_config *)  SB_BUFFER(0x31B0 + (i) * 7))    //  i < 4
//  Ethernet RX/TX Data/Ctrl
#define ETH_RX_DATA                     SB_BUFFER(0x3260)   //  25 * 32 DWORDs
#define ETH_RX_CTRL                     SB_BUFFER(0x2DA0)   //  25 * 1  DWORDs
#define ETH_TX_DATA                     SB_BUFFER(0x2C00)   //  13 * 32 DWORDs
#define ETH_TX_CTRL                     SB_BUFFER(0x2DC0)   //  13 * 1  DWORDs
