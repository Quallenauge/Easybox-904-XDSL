#ifndef __IFX_PPA_API_MFE_H__20100311_1703
#define __IFX_PPA_API_MFE_H__20100311_1703
/*******************************************************************************
**
** FILE NAME    : ifx_ppa_api_mfe.h
** PROJECT      : PPA
 ...
 * ####################################
 */
extern int32_t ifx_ppa_multifield_control(uint8_t enable, uint32_t flag) ;
extern int32_t ifx_ppa_get_multifield_status(uint8_t *enable, uint32_t flag);
extern int32_t ifx_ppa_get_multifield_max_flow(uint32_t flag);
extern int32_t ifx_ppa_add_multifield_flow( PPA_MULTIFIELD_FLOW_INFO *p_multifield_info, int32_t *index, uint32_t flag);   //hook
extern int32_t ifx_ppa_del_multifield_flow( PPA_MULTIFIELD_FLOW_INFO *p_multifield_info, uint32_t flag );   //hook
extern int32_t ifx_ppa_quick_del_multifield_flow( int32_t index, uint32_t flag) ;  //hook
...
#endif  // __IFX_PPA_API_MFE_H__20100311_1703
