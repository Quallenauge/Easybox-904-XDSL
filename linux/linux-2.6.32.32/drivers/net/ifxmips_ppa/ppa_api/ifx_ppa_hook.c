...
/********************************************************************************************** 
  ...
  * return: IFX_PPA_SESSION_ADDED: this session is added into PPE FW, ie, it is accelerated by PPE 
  *            IFX_PPA_SESSION_EXISTS: already added into PPE FW
  *            IFX_PPA_SESSION_NOT_ADDED: not added int PPE FW for some reasons.
  *            ...
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  * return: IFX_SUCCESS: this session is deleted sucessfully from PPE FW
  *            ...
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  * return: IFX_SUCCESS: this session is modified sucessfully
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t: flag indicates which kinds parameter will be modified 
  * return: IFX_PPA_SESSION_ADDED: this multicast session is added into PPE FW sucessfully
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  * return: IFX_PPA_SESSION_ADDED: this multicast session is added into PPE FW sucessfully
**********************************************************************************************/
int32_t (*ppa_hook_mc_group_get_fn)(IP_ADDR_C, PPA_MC_GROUP *, uint32_t) = NULL;
...
/********************************************************************************************** 
  ...
  * return: IFX_SUCCESS: modified/updated sucessfully.
  *            IFX_FAILURE: failed to update
**********************************************************************************************/
int32_t (*ppa_hook_mc_entry_modify_fn)(IP_ADDR_C, PPA_MC_GROUP *, PPA_SESSION_EXTRA *, uint32_t) = NULL;
...
/********************************************************************************************** 
  ...
  * return: IFX_SUCCESS: sucessfully get the multicast session's special parameter values.
**********************************************************************************************/
int32_t (*ppa_hook_mc_entry_get_fn)(IP_ADDR_C, PPA_SESSION_EXTRA *, uint32_t) = NULL;
...
/********************************************************************************************** 
  ...
  * return: IFX_PPA_HIT: the session still hit and should keep it
  *            IFX_PPA_TIMEOUT: timeout already
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  * return: IFX_SUCCESS: update timeout sucessfully
  *            IFX_FAILURE: fail to update timeout value
...
/********************************************************************************************** 
  ...
  *            IFX_PPA_SESSION_NOT_ADDED: not added int PPE FW for some reasons.
**********************************************************************************************/
int32_t (*ppa_hook_bridge_entry_add_fn)(uint8_t *, PPA_NETIF *, uint32_t) = NULL;
...
/********************************************************************************************** 
  ...
  * return: IFX_PPA_SESSION_ADDED: this session is added into PPE FW, ie, it is accelerated by PPE 
   * return: IFX_SUCCESS: set timeout value sucessfully.
  *            IFX_FAILURE: failed to update
**********************************************************************************************/
int32_t (*ppa_hook_bridge_entry_delete_fn)(uint8_t *, uint32_t) = NULL;
...
/********************************************************************************************** 
  ...
  * return: IFX_PPA_HIT: sucessfully get the last hit time 
  *            IFX_PPA_SESSION_NOT_ADDED: the mac address not in PPE FW yet
**********************************************************************************************/
int32_t (*ppa_hook_bridge_entry_hit_time_fn)(uint8_t *, uint32_t *) = NULL;
...
/********************************************************************************************** 
  ...
  * input parameter uint8_t *: the mac address
  * return: IFX_PPA_HIT: the mac address still hit
  *            IFX_PPA_TIMEOUT: timeout already
**********************************************************************************************/
int32_t (*ppa_hook_bridge_entry_inactivity_status_fn)(uint8_t *) = NULL;
...
/********************************************************************************************** 
  ...
  *            IFX_FAILURE: fail to update timeout value
**********************************************************************************************/
int32_t (*ppa_hook_set_bridge_entry_timeout_fn)(uint8_t *, uint32_t) = NULL;
...
/********************************************************************************************** 
  ...
  * return: IFX_SUCCESS: sucessfully
**********************************************************************************************/
int32_t (*ppa_hook_bridge_enable_fn)(uint32_t f_enable,  uint32_t flags) = NULL;
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: set  sucessfully
  *            IFX_FAILURE: fail to set vlan property for this interface
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: get  sucessfully
  *            IFX_FAILURE: fail to get vlan property from this interface
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: add  sucessfully
  *            IFX_FAILURE: fail to add 
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: delete  sucessfully
  *            IFX_FAILURE: fail to delete 
**********************************************************************************************/
...
/********************************************************************************************** 
  ...
  *            IFX_FAILURE: fail to delete 
**********************************************************************************************/
int32_t (*ppa_hook_vlan_filter_del_all_fn)(uint32_t);
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: send sucessfully
  *            others: fail to send
**********************************************************************************************/    
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t:  the virtual port id
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: stop sucessfully
  *            others: fail to stop
**********************************************************************************************/    
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t:  the virtual port id
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: restart forwarding sucessfully
...
/********************************************************************************************** 
  ...
  * return: virtual port id: if sucessully, otherwise return -1, ie, IFX_FAILURE
**********************************************************************************************/   
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: add sucessully
  *            IFX_FAILURE: fail to add
**********************************************************************************************/   
...
/********************************************************************************************** 
  ...
  * input parameter uint32_t: for future purpose
  * return: IFX_SUCCESS: delete sucessully
  *            IFX_FAILURE: fail to delete
**********************************************************************************************/   
...
/********************************************************************************************** 
  ...
  * return: IFX_SUCCESS: get destination mac address sucessully
  *            IFX_FAILURE: fail to get destination mac address
**********************************************************************************************/   
int32_t (*ppa_get_6rd_dmac_fn)(PPA_NETIF *netif, uint8_t *mac) = NULL;
PPA_NETIF* (*ppa_get_6rd_phyif_fn)(PPA_NETIF *netif)= NULL;

#ifdef CONFIG_IFX_PPA_QOS
int32_t (*ifx_ppa_hook_get_qos_qnum)( uint32_t portid, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_get_qos_mib)( uint32_t portid, uint32_t queueid, PPA_QOS_MIB *mib, uint32_t flag) = NULL;
#ifdef CONFIG_IFX_PPA_QOS_RATE_SHAPING
int32_t (*ifx_ppa_hook_set_ctrl_qos_rate)( uint32_t portid, uint32_t enable, uint32_t flag ) = NULL;
int32_t (*ifx_ppa_hook_get_ctrl_qos_rate)( uint32_t portid, uint32_t *enable, uint32_t flag ) = NULL;
int32_t (*ifx_ppa_hook_set_qos_rate)( uint32_t portid, uint32_t queueid, uint32_t rate, uint32_t burst, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_get_qos_rate)( uint32_t portid, uint32_t queueid, uint32_t *rate, uint32_t *burst, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_reset_qos_rate)( uint32_t portid, uint32_t queueid, uint32_t flag ) = NULL;
#endif  //end of  CONFIG_IFX_PPA_QOS_RATE_SHAPING

#ifdef CONFIG_IFX_PPA_QOS_WFQ
int32_t (*ifx_ppa_hook_set_ctrl_qos_wfq)( uint32_t portid, uint32_t enable, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_get_ctrl_qos_wfq)( uint32_t portid, uint32_t *enable, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_set_qos_wfq)( uint32_t portid, uint32_t queueid, uint32_t weight_level, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_get_qos_wfq)( uint32_t portid, uint32_t queueid, uint32_t *weight_level, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_reset_qos_wfq)( uint32_t portid, uint32_t queueid, uint32_t flag ) = NULL;
#endif  //end of  CONFIG_IFX_PPA_QOS_WFQ

#endif  //end of CONFIG_IFX_PPA_QOS

#ifdef CONFIG_IFX_PPA_MFE
int32_t (*ifx_ppa_hook_multifield_control)(uint8_t enable, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_get_multifield_status)(uint8_t* enable, uint32_t flag)  = NULL;
int32_t (*ifx_ppa_hook_get_multifield_max_flow)(uint32_t flag) =  NULL;
int32_t (*ifx_ppa_hook_add_multifield_flow)( PPA_MULTIFIELD_FLOW_INFO *p_multifield_info, int32_t *index, uint32_t flag)  = NULL;
int32_t (*ifx_ppa_hook_del_multifield_flow)( PPA_MULTIFIELD_FLOW_INFO *p_multifield_info, uint32_t flag )  = NULL;
int32_t (*ifx_ppa_hook_quick_del_multifield_flow)( int32_t index, uint32_t flag)  = NULL;
#endif //end of CONFIG_IFX_PPA_MFE

int32_t (*ifx_ppa_hook_get_dsl_mib)(PPA_DSL_QUEUE_MIB *mib, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_get_port_mib)(PPA_PORT_MIB *mib) = NULL;
...
/*Below varabiles are used for debugging only: force PPE driver to use kernel's boot parameter:
   if ifx_ppa_drv_datapath_dbg_param_enable is enabled, then PPE driver will take parameter from kernel's boot paramter whether
   PPE driver is static build in kernel or dynamic modules.

   Note, only if ifx_ppa_drv_dp_dbg_param_enable is enabled and PPE driver is in loadable module, then this feature may be activated.
   Otherwise, it will never be activated at all.

   For other non-linux OS, just disabled this feature, ie, not enable macro IFX_PPA_DP_DBG_PARAM_ENABLE
*/
int  ifx_ppa_drv_dp_dbg_param_enable = 0;
int  ifx_ppa_drv_dp_dbg_param_ethwan = 0;
int  ifx_ppa_drv_dp_dbg_param_wanitf = ~0;
int  ifx_ppa_drv_dp_dbg_param_ipv6_acc_en = 1;
int  ifx_ppa_drv_dp_dbg_param_wanqos_en = 8;

static int __init ifx_ppa_drv_dp_dbg_param_enable_setup(char *line)
{
    if ( strcmp(line, "1") == 0 )
        ifx_ppa_drv_dp_dbg_param_enable = 1;       
        
   return 0;
}

static int __init ifx_ppa_drv_dp_dbg_param_wan_mode_setup(char *line)
{
    if ( strcmp(line, "1") == 0 )
        ifx_ppa_drv_dp_dbg_param_ethwan = 1;
    else if ( strcmp(line, "2") == 0 )
        ifx_ppa_drv_dp_dbg_param_ethwan = 2;    

    return 0;
}

static int __init ifx_ppa_drv_dp_dbg_param_wanitf_setup(char *line)
{
    ifx_ppa_drv_dp_dbg_param_wanitf = simple_strtoul(line, NULL, 0);

    if ( ifx_ppa_drv_dp_dbg_param_wanitf > 0xFF )
        ifx_ppa_drv_dp_dbg_param_wanitf = ~0;

    return 0;
}

static int __init ifx_ppa_drv_dp_dbg_param_ipv6_acc_en_setup(char *line)
{
    if ( strcmp(line, "0") == 0 )
        ifx_ppa_drv_dp_dbg_param_ipv6_acc_en = 0;
    else
        ifx_ppa_drv_dp_dbg_param_ipv6_acc_en = 1;

    return 0;
}

static int __init ifx_ppa_drv_dp_dbg_param_wanqos_en_setup(char *line)
{
    ifx_ppa_drv_dp_dbg_param_wanqos_en = simple_strtoul(line, NULL, 0);

    if ( ifx_ppa_drv_dp_dbg_param_wanqos_en > 8 )
        ifx_ppa_drv_dp_dbg_param_wanqos_en = 0;

    return 0;
}

__setup("param_en=", ifx_ppa_drv_dp_dbg_param_enable_setup);
__setup("ethwan=", ifx_ppa_drv_dp_dbg_param_wan_mode_setup);
__setup("wanitf=", ifx_ppa_drv_dp_dbg_param_wanitf_setup);
__setup("ipv6_acc_en=", ifx_ppa_drv_dp_dbg_param_ipv6_acc_en_setup);
__setup("wanqos_en=", ifx_ppa_drv_dp_dbg_param_wanqos_en_setup);
#endif //end of IFX_PPA_DP_DBG_PARAM_ENABLE

EXPORT_SYMBOL(ifx_ppa_drv_dp_dbg_param_enable);
EXPORT_SYMBOL(ifx_ppa_drv_dp_dbg_param_ethwan);
EXPORT_SYMBOL(ifx_ppa_drv_dp_dbg_param_wanitf);
EXPORT_SYMBOL(ifx_ppa_drv_dp_dbg_param_ipv6_acc_en);
EXPORT_SYMBOL(ifx_ppa_drv_dp_dbg_param_wanqos_en);
...
#ifdef CONFIG_IFX_PPA_MFE
EXPORT_SYMBOL(ifx_ppa_hook_multifield_control);
EXPORT_SYMBOL(ifx_ppa_hook_get_multifield_status);
EXPORT_SYMBOL(ifx_ppa_hook_get_multifield_max_flow);
EXPORT_SYMBOL(ifx_ppa_hook_add_multifield_flow);
EXPORT_SYMBOL(ifx_ppa_hook_del_multifield_flow);
EXPORT_SYMBOL(ifx_ppa_hook_quick_del_multifield_flow);
#endif // CONFIG_IFX_PPA_MFE 

#ifdef CONFIG_IFX_PPA_QOS
EXPORT_SYMBOL(ifx_ppa_hook_get_qos_qnum);
EXPORT_SYMBOL(ifx_ppa_hook_get_qos_mib);

#ifdef CONFIG_IFX_PPA_QOS_RATE_SHAPING
EXPORT_SYMBOL(ifx_ppa_hook_set_ctrl_qos_rate);
EXPORT_SYMBOL(ifx_ppa_hook_get_ctrl_qos_rate);
EXPORT_SYMBOL(ifx_ppa_hook_set_qos_rate);
EXPORT_SYMBOL(ifx_ppa_hook_get_qos_rate);
EXPORT_SYMBOL(ifx_ppa_hook_reset_qos_rate);
#endif // CONFIG_IFX_PPA_QOS_RATE_SHAPING

#ifdef CONFIG_IFX_PPA_QOS_WFQ
EXPORT_SYMBOL(ifx_ppa_hook_set_ctrl_qos_wfq);
EXPORT_SYMBOL(ifx_ppa_hook_get_ctrl_qos_wfq);
EXPORT_SYMBOL(ifx_ppa_hook_set_qos_wfq);
EXPORT_SYMBOL(ifx_ppa_hook_get_qos_wfq);
EXPORT_SYMBOL(ifx_ppa_hook_reset_qos_wfq);
#endif // end of CONFIG_IFX_PPA_QOS_WFQ
#endif //end of CONFIG_IFX_PPA_QOS
EXPORT_SYMBOL(ifx_ppa_hook_get_dsl_mib);
EXPORT_SYMBOL(ifx_ppa_hook_get_port_mib);
