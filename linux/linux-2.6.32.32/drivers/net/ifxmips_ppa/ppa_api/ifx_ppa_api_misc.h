#ifndef __IFX_PPA_API_MISC_H__20081103_1952__
#define __IFX_PPA_API_MISC_H__20081103_1952__



/*******************************************************************************
**
** FILE NAME    : ifx_ppa_api_misc.h
** PROJECT      : PPA
...
/** \addtogroup PPA_MISC_API PPA Miscellaneous API
    \brief  PPA Miscellaneous API provide PPA Miscellaneous api and IOCTL API
            ...
            - ifx_ppa_api_misc.h: Header file for PPA API
            - ifx_ppa_api_misc.c: C Implementation file for PPA API
*/
/* @{ */
...
#define ENABLE_DYNAMIC_NETIF_DETECTION          0
  ...
  #undef  dbg
  #define dbg(format, arg...)                   do { if ( (g_ppa_dbg_enable & DBG_ENABLE_MASK_DEBUG_PRINT) ) printk(KERN_WARNING __FILE__ ":%d:%s: " format "\n", __LINE__, __FUNCTION__, ##arg); } while ( 0 )
#else
  #if !defined(dbg)
...
/*ppa_debug currently supported flags:
        ...
        DBG_ENABLE_MASK_PWM,
        DBG_ENABLE_MASK_ALL*/
#define ppa_debug(flag, fmt, arg...) do { if (g_ppa_dbg_enable & flag) ppa_printk(fmt,##arg) ; } while ( 0 )
...
#endif  //  __IFX_PPA_API_MISC_H__20081103_1952__
