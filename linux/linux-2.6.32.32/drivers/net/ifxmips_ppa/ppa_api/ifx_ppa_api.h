...
*/
typedef struct {
    IPADDR          ip_mc_group;    /*!<   Multicast IP address group */
    ...
    IPADDR     source_ip;    /*!<  source ip address */
} PPA_MC_GROUP;
...
*/
typedef struct {
    IPADDR              mcast_addr; /*!< MAC address of the entry */
    uint8_t             SSM_flag; /*!< ssm flag */
    IPADDR              source_ip;  /*!< source ip */    
