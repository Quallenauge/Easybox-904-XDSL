/******************************************************************************
**
** FILE NAME    : ifxmips_ppa_hal_vr9_a5.h
** PROJECT      : UEIP
...
*******************************************************************************/
#ifndef IFXMIPS_PPA_HAL_VR9_A5_H
#define IFXMIPS_PPA_HAL_VR9_A5_H
...
#define DSL_QUEUE_RX_MIB_TABLE(i)               ((volatile struct dsl_queue_mib *)          SB_BUFFER(0x4F00 + (i) * 2))    /*  i < 2   */
#define DSL_QUEUE_TX_MIB_TABLE(i)               ((volatile struct dsl_queue_mib *)          SB_BUFFER(0x4F40 + (i) * 2))    /*  i < 15  */
#define DSL_QUEUE_TX_DROP_MIB_TABLE(i)          ((volatile struct dsl_queue_drop_mib *)     SB_BUFFER(0x47F0 + (i)))        /*  i < 15  */
...
#define TUNNEL_6RD_TBL(i)                       SB_BUFFER(0x47E4  + (i) * 5)     /*  i < 4    */
