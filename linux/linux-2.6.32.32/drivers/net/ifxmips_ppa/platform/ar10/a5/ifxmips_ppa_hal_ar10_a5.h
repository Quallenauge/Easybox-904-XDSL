/******************************************************************************
**
** FILE NAME    : ifxmips_ppa_hal_ar10_a5.h
** PROJECT      : UEIP
...
#ifndef IFXMIPS_PPA_HAL_AR10_A5_H
#define IFXMIPS_PPA_HAL_AR10_A5_H
...
#define DSL_QUEUE_RX_MIB_TABLE(i)               ((volatile struct dsl_queue_mib *)          SB_BUFFER(0x2040 + (i) * 2))    /*  i < 2   */
#define DSL_QUEUE_TX_MIB_TABLE(i)               ((volatile struct dsl_queue_mib *)          SB_BUFFER(0x2D60 + (i) * 2))    /*  i < 15  */
#define DSL_QUEUE_TX_DROP_MIB_TABLE(i)          ((volatile struct dsl_queue_drop_mib *)     SB_BUFFER(0x2D80 + (i)))    /*  i < 15  */
...
#endif /* IFXMIPS_PPA_HAL_AR10_A5_H */
