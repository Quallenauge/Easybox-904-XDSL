...
#define IFX_PPA_PHYS_PORT_FLAGS_MODE_EXT_WAN_VALID		(IFX_PPA_PHYS_PORT_FLAGS_TYPE_EXT | IFX_PPA_PHYS_PORT_FLAGS_MODE_WAN | IFX_PPA_PHYS_PORT_FLAGS_VALID)
...
typedef enum {
  ...
  PPA_GENERIC_HAL_CLEAR_PORT_MIB,   //clear all ports mib
...
//Fix warning message when exports API from different PPE FW Driver--begin
  ...
  PPA_GENERIC_HAL_GET_6RD_TUNNEL_ENTRY,  //get a tunnel entry
  ...
  PPA_GENERIC_HAL_TEST_CLEAR_BR_HIT_STAT, //check whether a routing session is hit or not
...
#define IFX_PPA_PWM_LEVEL_D0                            0
#define IFX_PPA_PWM_LEVEL_D1                            1
#define IFX_PPA_PWM_LEVEL_D2                            2
#define IFX_PPA_PWM_LEVEL_D3                            3
...
extern int32_t (*ifx_ppa_drv_hal_generic_hook)(PPA_GENERIC_HOOK_CMD cmd, void *buffer, uint32_t flag);
