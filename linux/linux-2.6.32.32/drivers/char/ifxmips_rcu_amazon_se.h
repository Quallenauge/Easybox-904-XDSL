/******************************************************************************
**
** FILE NAME    : ifxmips_rcu_amazon_se.h
** PROJECT      : UEIP
** MODULES      : RCU (Reset Control Unit)
**
** DATE         : 17 Jun 2009
** AUTHOR       : Xu Liang
** DESCRIPTION  : RCU driver header file for Amazon-SE
...
#ifndef IFXMIPS_RCU_AMAZON_SE_H
#define IFXMIPS_RCU_AMAZON_SE_H
...
static ifx_rcu_domain_t g_rcu_domains[IFX_RCU_DOMAIN_MAX] = {
    ...
    },
    {
        ...
        .affected_domains   = 1 << IFX_RCU_DOMAIN_DSLDSP,
        .rst_req_value      = 0,
        .rst_req_mask       = 0,
        .rst_stat_mask      = 0,
        .latch              = 0,
    ...
    {
        //  IFX_RCU_DOMAIN_USB1
        .affected_domains   = 1 << IFX_RCU_DOMAIN_USB1,
        .rst_req_value      = 0,
        .rst_req_mask       = 0,
        .rst_stat_mask      = 0,
        .latch              = 0,
    ...
    {
        //  IFX_RCU_DOMAIN_USB0
        .affected_domains   = 1 << IFX_RCU_DOMAIN_USB0,
        .rst_req_value      = 1 << 4,
        .rst_req_mask       = 1 << 4,
        .rst_stat_mask      = 1 << 4,
        .latch              = 0,
    ...
    },
    {
        ...
        .affected_domains   = (1 << IFX_RCU_DOMAIN_DSLDFE) | (1 << IFX_RCU_DOMAIN_ARC),
        .rst_req_value      = 1 << 7,
        .rst_req_mask       = 1 << 7,
        .rst_stat_mask      = 1 << 7,
        .latch              = 0,
    ...
    {
        //  IFX_RCU_DOMAIN_PPE
        .affected_domains   = (1 << IFX_RCU_DOMAIN_PPE) | (1 << IFX_RCU_DOMAIN_DSLDFE) | (1 << IFX_RCU_DOMAIN_ARC) | (1 << IFX_RCU_DOMAIN_DSLTC),
        .rst_req_value      = 1 << 8,
        .rst_req_mask       = 1 << 8,
        .rst_stat_mask      = 1 << 8,
        .latch              = 0,
