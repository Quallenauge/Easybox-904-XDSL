/******************************************************************************
**
** FILE NAME    : ifxmips_si_vr9.h
** PROJECT      : UEIP
** MODULES      : Serial In Controller
**
** DATE         : 26 Apr 2010
** AUTHOR       : Xu Liang
** DESCRIPTION  : Serial In Controller driver header file for VR9
...
#ifndef IFXMIPS_SI_VR9_H
#define IFXMIPS_SI_VR9_H
