/******************************************************************************
**
** FILE NAME    : ifxmips_rcu_danube.h
** PROJECT      : UEIP
** MODULES      : RCU (Reset Control Unit)
**
** DATE         : 17 Jun 2009
** AUTHOR       : Xu Liang
** DESCRIPTION  : RCU driver header file for Danube
...
#ifndef IFXMIPS_RCU_DANUBE_H
#define IFXMIPS_RCU_DANUBE_H
