...
** DESCRIPTION  : IFX VR9 Central DMA driver header file
...
#ifndef _IFXMIPS_DMA_VR9_H_
#define _IFXMIPS_DMA_VR9_H_
...
/* VR9 Supported Devices */
static char dma_device_name[7][20] = {{"PPE"},{"DEU" },{"SPI" },{"SDIO"  },{"MCTRL0"},{"USIF"  },{"HSNAND"}};
static _dma_chan_map ifx_default_dma_map[28] = {
