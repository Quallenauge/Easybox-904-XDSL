/**
** FILE NAME    : ifxmips_dma_ar9.h
** PROJECT      : IFX UEIP
** MODULES      : Central DMA
** DATE         : 03 June 2009
** AUTHOR       : Reddy Mallikarjuna
** DESCRIPTION  : IFX AR9 Central DMA driver header file
...
#ifndef _IFXMIPS_DMA_AR9_H_
#define _IFXMIPS_DMA_AR9_H_

/*!
  \file ifxmips_dma_ar9.h
  \ingroup IFX_DMA_CORE
  \brief Header file for IFX Central DMA  driver internal definition for ARx platform.
*/
